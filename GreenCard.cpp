...
void GreenCard::print(){
	cout<<"Attack Bonus: "<<attackBonus<<" Defence Bonus: "<<defenceBonus<<" Minimum Honour: "<<minimumHonnor<<endl<<"Text:"<<cardText<<" Effect Cost: "<<effectCost<<" Effect Bonus: "<<effectBonus;
}
