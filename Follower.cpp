...
#inlude "Follower.hpp"
using namespace std;
Follower::Follower(string givenName, int givenCost, int givenAttBonus,int givenDefBonus,int givenMinHonnor, string givenText,int givenEffectCost):Green(givenName,givenCost,givenAttBonus,givenDefBonus,givenMinHonnor,givenTextm,givenEffectBonus,givenEffectCost){}
...
Naval::Naval(string GivenName):Follower(GivenName,3,2,4,3,"SAMPLETEXT",3,4){}
